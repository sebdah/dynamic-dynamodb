...
DEFAULT_OPTIONS = {
    ...
    'table': {
        ...
        'gsi_provisioning': False,
        'gsi_reads_lower_threshold': 30,
        'gsi_reads_upper_threshold': 90,
        'gsi_increase_reads_with': 50,
        'gsi_decrease_reads_with': 50,
        'gsi_increase_reads_unit': 'percent',
        'gsi_decrease_reads_unit': 'percent',
        'gsi_writes_lower_threshold': 30,
        'gsi_writes_upper_threshold': 90,
        'gsi_increase_writes_with': 50,
        'gsi_decrease_writes_with': 50,
        'gsi_increase_writes_unit': 'percent',
        'gsi_decrease_writes_unit': 'percent',
        'gsi_min_provisioned_reads': None,
        'gsi_max_provisioned_reads': None,
        'gsi_min_provisioned_writes': None,
        'gsi_max_provisioned_writes': None,
